...
#define UNNAME_DECLARE(_TYPE) _TYPE __MULTLOCAL00(_00_anonymous__)

#define COMInit(a) UNNAME_DECLARE(ipc_utils::COMInit_t)(a)
#define COMInitA UNNAME_DECLARE(ipc_utils::COMInitA_t)
#define COMInitF UNNAME_DECLARE(ipc_utils::COMInitF_t)
...
namespace ipc_utils {
	...
	*/
	...
	struct COMInit_t
	{
		...
		inline static bool is_STA() { return  apartment_type()== COINIT_APARTMENTTHREADED;}
	};
